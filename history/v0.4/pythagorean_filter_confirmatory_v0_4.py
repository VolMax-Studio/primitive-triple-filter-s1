...
PROTOCOL = "PYTHAGOREAN_FILTER_CONFIRMATORY_SPEC_v0_4.md"
BITS = 100_000
N_PAIRS = 30
REPEATS = 8
...
def validate_gate(record_path):
    ...
    seed_material = (b"pythagorean-filter-v0.4\x00" + bytes.fromhex(script_hash)
...
def main():
    ...
    if args.smoke:
        ...
        smoke_seed = "smoke-only-separate-stream-v0.4"
        seen = set()
